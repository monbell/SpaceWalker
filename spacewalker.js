...
export class Assignment3 extends Scene {
    constructor() {
        ...
        this.ring_planet_loc = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
        this.ring_planet_speed = Math.random()*10 + 10; 
        
        this.rand = Math.floor(Math.random()*this.positions.length);
        this.planet_loc = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
        this.planet_speed = Math.random()*10 + 10; 

        this.rand = Math.floor(Math.random()*this.positions.length);
        this.star_loc = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
        this.star_speed = Math.random()*10 + 10; 
        
        this.rand = Math.floor(Math.random()*this.positions.length);
        this.meteor_loc = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
        this.meteor_speed = Math.random()*10 + 10; 

        this.rand = Math.floor(Math.random()*this.positions.length);
        this.ring_planet_loc_2 = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
        this.ring_planet_speed_2 = Math.random()*10 + 10; 

        this.rand = Math.floor(Math.random()*this.positions.length);
        this.planet_loc_2 = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
        this.planet_speed_2 = Math.random()*10 + 10;

        this.rand = Math.floor(Math.random()*this.positions.length);
        this.star_loc_2 = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
        this.star_speed_2 = Math.random()*10 + 10; 

        this.rand = Math.floor(Math.random()*this.positions.length);
        this.meteor_loc_2 = this.positions[this.rand];
        this.positions.splice(this.rand, 1);
    ...
    display(context, program_state) {
        ...
        else
        {
            ...
            if(!this.end) {
                ...
                if( ((this.meteor_transform[1][3] - this.center[1][3]) < 3 && (this.meteor_transform[1][3] - this.center[1][3]) > -3) && ((this.meteor_transform[0][3] - this.center[0][3]) < 4.5 && (this.meteor_transform[0][3] - this.center[0][3]) > -4.5)) {
                    this.collided = true;
                }
                ...
                if( ((this.meteor_transform_2[1][3] - this.center[1][3]) < 3 && (this.meteor_transform_2[1][3] - this.center[1][3]) > -3) && ((this.meteor_transform_2[0][3] - this.center[0][3]) < 4.5 && (this.meteor_transform_2[0][3] - this.center[0][3]) > -4.5)) {
                    this.collided = true;
                }
                ...
                this.shapes.triangle.draw(context, program_state, this.shooting_star_transform, this.materials.shooting_star_mat); 
                if( ((this.shooting_star_transform[1][3] - this.center[1][3]) < 3 && (this.shooting_star_transform[1][3] - this.center[1][3]) > -3) && ((this.shooting_star_transform[0][3] - this.center[0][3]) < 4.5 && (this.shooting_star_transform[0][3] - this.center[0][3]) > -4.5)) {
                    this.collided = true;
                }                
                ...
                this.shapes.triangle.draw(context, program_state, this.shooting_star_transform_2, this.materials.shooting_star_mat);
                if( ((this.shooting_star_transform_2[1][3] - this.center[1][3]) < 3 && (this.shooting_star_transform_2[1][3] - this.center[1][3]) > -3) && ((this.shooting_star_transform_2[0][3] - this.center[0][3]) < 4.5 && (this.shooting_star_transform_2[0][3] - this.center[0][3]) > -4.5)) {
                    this.collided = true;
                } 
                ...
                if( ((this.planet_transform[1][3] - this.center[1][3]) < 3 && (this.planet_transform[1][3] - this.center[1][3]) > -3) && ((this.planet_transform[0][3] - this.center[0][3]) < 4.5 && (this.planet_transform[0][3] - this.center[0][3]) > -4.5)) {
                    this.collided = true;
                }
                ...
                if( ((this.planet_transform_2[1][3] - this.center[1][3]) < 3 && (this.planet_transform_2[1][3] - this.center[1][3]) > -3) && ((this.planet_transform_2[0][3] - this.center[0][3]) < 4.5 && (this.planet_transform_2[0][3] - this.center[0][3]) > -4.5)) {
                    this.collided = true;
                }
                ...
                if( ((this.rings_transform_2[1][3] - this.center[1][3]) < 3 && (this.rings_transform_2[1][3] - this.center[1][3]) > -3) && ((this.rings_transform_2[0][3] - this.center[0][3]) < 6 && (this.rings_transform_2[0][3] - this.center[0][3]) > -6)) {
                    this.collided = true;
                }
            }
            else {
